...
export default function Carousel({ images, itemWidth = 40, itemHeight = 40, spacing = 60 }: { images: string[], itemWidth?: number, itemHeight?: number, spacing?: number }) {
  ...
  return (
    <div className="overflow-hidden w-full relative h-full">
      <div className='w-16 h-full absolute top-0 left-0 bg-gradient-to-r from-secondary to-transparent z-20' />
      <div className='w-16 h-full absolute top-0 right-0 bg-gradient-to-l from-secondary to-transparent z-20' />
